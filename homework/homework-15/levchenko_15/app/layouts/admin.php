...
<div>
    <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="margin-left: 15%">
        <ul class="navbar-nav">
            <li class="nav-item d-none d-sm-inline-block">
                <a href="/news" class="nav-link">News</a>
            </li>
            <li class="nav-item d-none d-sm-inline-block">
                <a href="/brick" class="nav-link">Bricks</a>
            </li>
        </ul>
    ...
    <div class="wrapper">
        <main>
            <aside class="main-sidebar sidebar-dark-primary elevation-4" style="width: 15%; height: 100%">
                <nav class="mt-2">
            ...
            <div class="content-fluid" style="margin-left: 15%">
                <?= $content ?>
            </div>
        </main>
    </div>

    <footer class="main-footer" style="margin-left: 15%">
        <div class="float-right d-none d-sm-block" style="margin-right: 5%">
            <br><b>Version</b> 3.1.0
        </div>
        <div style="text-align: center">
            <br><strong>Copyright © 2014-2021 <a href="https://adminlte.io">AdminLTE.io</a>.</strong> All rights reserved.
        </div>
